 ...
 */
public class TopscoreQuizView extends GridPane {

    //Variabelen declareren

    private Label lblTypeScore;
    private Label lblScoreSpel;
    private ImageView imgTopscore;
    ...
    Label getLblScoreSpel() { return lblScoreSpel; }
    ...
    private void initialiseNodes(){
        ...
        lblScoreSpel = new Label("Jouw score is: ");
        imgTopscore = new ImageView("/afbeeldingen/topscore/topscore.png");
        imgTopscore.setFitWidth(120);
        imgTopscore.setPreserveRatio(true);
        lblHighScore = new Label("Proficiat! Je heb een Topscore behaald. Je staat op plaats...");
        lblHighScore.setFont(ViewConstants.LABEL_LARGE);
    ...
    private void layoutNodes() {
        lblTypeScore.setFont(Font.font(12));
        lblScoreSpel.setFont(Font.font(12));
        ...
        this.add(lblTypeScore,0,0,2,1);
        setHalignment(lblTypeScore, HPos.LEFT);
        this.add(lblScoreSpel,2,0,2,1);
        this.add(imgTopscore,1,0,3,1);
        setHalignment(imgTopscore, HPos.CENTER);
        this.add(lblHighScore,0,1,4,1);
        setHalignment(lblScoreSpel, HPos.RIGHT);
        setHalignment(lblHighScore, HPos.CENTER);
